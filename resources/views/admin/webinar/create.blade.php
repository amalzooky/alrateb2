                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form" action="{{route('admin.virtualclass.webinar.store')}}"
                                              method="POST"
                                            ...
                                            <div class="form-body">
                                                ...
                                                <h4 class="form-section"><i class="ft-home"></i> إنشاء webinar </h4>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="meeting-time-end"> وقت انتهاء الحصة </label>
                                                            <input class="form-control" type="datetime-local"
                                                                   id="meeting-time-end" name="webinar_end_time" required>
                                                            @error("")
                                                            <span class="text-danger"> هذا الحقل مطلوب</span>
                                                            @enderror
                                                        </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="webinar_description">وصف الحصه</label>
                                                            <textarea class="form-control" id="webinar_description" name="webinar_description" required></textarea>
                                                            @error("")
                                                            <span class="text-danger"> هذا الحقل مطلوب</span>
                                                            @enderror
                                                        </div>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group mt-1">
                                                            <label for="webinar_description">حساب الويبنر</label>
                                                            <select class="form-control" name="webinar_account">
