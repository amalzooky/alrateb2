<div class="main-menu menu-fixed menu-light menu-accordion    menu-shadow " data-scroll-to-active="true">
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="nav-item  ">
                <a href=""><i class="la la-home"></i>
                    <span class="menu-title" data-i18n="nav.dash.main"> وظيفة المستخدم </span>
                    <span
                        class="badge badge badge-info badge-pill float-right mr-2">{{App\Models\TypeUser::count()}}</span>
                </a>
                <ul class="menu-content">
                    <li class=""><a class="menu-item" href="{{route('admin.typeusers')}}"
                                    data-i18n="nav.dash.ecommerce"> عرض الكل </a>
                    </li>
                    <li><a class="menu-item" href="{{route('admin.typeusers.create')}}" data-i18n="nav.dash.crypto">أضافة
                            وظيفة جديده </a>
                    </li>
                </ul>
            </li>
 <li class=" nav-item"><a href="#"><i class="la la-television">
         ...
         data-i18n="nav.templates.main">البث المباشر </span></a>
                <ul class="menu-content">
                    <li><a class="menu-item" href="{{route('admin.virtualclass.create')}}" data-i18n="nav.templates.vert.main">زوم</a>
                      
                    </li>
                </ul>
                <ul class="menu-content">
                    <li><a class="menu-item" href="{{route('admin.virtualclass.wiziq.create')}}" data-i18n="nav.templates.vert.main">ويزيك</a>
                      
                    </li>
                </ul>
                <ul class="menu-content">
                    <li><a class="menu-item" href="{{route('admin.virtualclass.webinar.create')}}" data-i18n="nav.templates.vert.main">ويبنر </a>
                      
                    </li>
                </ul>
                <ul class="menu-content">
                    <li><a class="menu-item" href="{{route('admin.virtualclass.zoomwiziq.create')}}" data-i18n="nav.templates.vert.main">زوم وويزك </a>
                      
                    </li>
                </ul>
                  <ul class="menu-content">
                    <li><a class="menu-item" href="#" data-i18n="nav.templates.vert.main"> بج بلو </a>
            ...
            <li class="nav-item"><a href=""><i class="la la-group"></i>
                    <span class="menu-title" data-i18n="nav.dash.main">الشئون الاكاديمية </span>
                    <span
                ...
                @if($categories && $categories -> count() > 0)
                    @foreach($categories as $category)
                        ...
                        <ul class="menu-content">
                            ...
                            <li><a class="menu-item" href="{{$category -> id }}"
                                   data-i18n="nav.templates.vert.main">{{$category -> name}}</a>
                                <ul class="menu-content">
                                    @php
                                        if ($category->id === 1 || $category->id === 2){
                                             $indexRoute = route('admin.schoolyears');
                                             $createRoute = route('admin.schoolyears.create');
                                        } elseif ($category->id === 3 || $category->id === 4){
                                            $indexRoute = route('admin.majors');
                                            $createRoute = route('admin.majors.create');
                                        } elseif ($category->id === 5 || $category->id === 6){
                                            $indexRoute = route('admin.subjects');
                                            $createRoute = route('admin.subjects.create');
                                        } elseif ($category->id === 7 || $category->id === 8){
                                            $indexRoute = route('admin.schoolsitems');
                                            $createRoute = route('admin.schoolsitems.create');
                                        } elseif ($category->id === 9 || $category->id === 10){
                                            $indexRoute = route('admin.lectures');
                                            $createRoute = route('admin.lectures.create');
                                        } elseif ($category->id === 9 || $category->id === 10){
                                            $indexRoute = route('admin.lectures');
                                            $createRoute = route('admin.lectures.create');
                                        } elseif ($category->id === 12){
                                            $indexRoute = route('admin.students');
                                            $createRoute = route('admin.students.create');
                                        } elseif ($category->id === 14){
                                            $indexRoute = route('admin.teachers');
                                            $createRoute = route('admin.teachers.create');
                                              } elseif ($category->id === 15 || $category->id === 16){
                                            $indexRoute = route('admin.groupes');
                                            $createRoute = route('admin.groupes.create');
                                        } else {
                                            $indexRoute = route('admin.dashboard');
                                            $createRoute = route('admin.dashboard');
                                        }
                                    @endphp
                                    <li><a class="menu-item" href="{{$indexRoute}}"
                                           data-i18n="nav.templates.vert.overlay_menu">كل {{$category -> name}} </a>
                                    </li>
                                    <li><a class="menu-item" href="{{$createRoute}}"
                                           data-i18n="nav.templates.vert.overlay_menu">أضافة {{$category -> name}} </a>
                                    </li>
                                </ul>
                            </li>
            ...
            <li class="nav-item"><a href=""><i class="la la-male"></i>
                ...
                <ul class="menu-content">
                    <li class=""><a class="menu-item" href="{{route('admin.students')}}"
                                    data-i18n="nav.dash.ecommerce"> عرض الكل </a>
                    </li>
                    <li><a class="menu-item" href="{{route('admin.students.create')}}" data-i18n="nav.dash.crypto">أضافة
                            طالب </a>
                    </li>
                </ul>
            </li>
            <li class="nav-item"><a href=""><i class="la la-male"></i>
                    <span class="menu-title" data-i18n="nav.dash.main">المعلمين  </span>
                    <span
                        class="badge badge badge-success badge-pill float-right mr-2">{{App\Models\Teacher::count()}}</span>
                </a>
                <ul class="menu-content">
                    <li class=""><a class="menu-item" href="{{route('admin.teachers')}}"
                                    data-i18n="nav.dash.ecommerce"> عرض الكل </a>
                    </li>
                    <li><a class="menu-item" href="{{route('admin.teachers.create')}}" data-i18n="nav.dash.crypto">أضافة
                            معلم </a>
                    </li>
                </ul>
            </li>
            ...
            <li class="nav-item">
                <a href=""><i class="la la-male"></i>
                    <span class="menu-title" data-i18n="nav.dash.main">المحتوي الدراسي</span>
                    <span
                        class="badge badge badge-danger  badge-pill float-right mr-2">{{App\Models\Materials::count()}}</span>
                </a>
                <ul class="menu-content">
                    <li class=""><a class="menu-item" href="{{route('admin.materials')}}"
                                    data-i18n="nav.dash.ecommerce">  المحتوي الدراسية  </a>
                    </li>  
                     <li class=""><a class="menu-item" href="{{route('admin.materials.create')}}"
                                    data-i18n="nav.dash.ecommerce"> أضافة محتوي دراسية </a>
                    </li>
                </ul>
            </li>
            ...
            <li class=" nav-item"><a href="#"><i class="la la-television"></i><span class="menu-title"
                data-i18n="nav.templates.main">الموقع الرئيسي</span></a>
                <ul class="menu-content">
                    <li><a class="menu-item" href="{{route('admin.slider')}}" data-i18n="nav.templates.vert.main">الصور المتحركه</a>
                        <ul class="menu-content">
                            <li><a class="menu-item" href="{{route('admin.slider')}}"
                                   data-i18n="nav.templates.vert.classic_menu">كل الصور المتحركه</a>
                            </li>
                            <li><a class="menu-item" href="{{route('admin.slider.create')}}">أضافة الصور المتحركه</a>
                            </li>
                ...
                <ul class="menu-content">
                    <li><a class="menu-item" href="{{route('admin.services')}}" data-i18n="nav.templates.vert.main">الخدمات </a>
                        <ul class="menu-content">
                            <li><a class="menu-item" href="{{route('admin.services')}}"
                                   data-i18n="nav.templates.vert.classic_menu"> كل الخدمات</a>
                            </li>
                            <li><a class="menu-item" href="{{route('admin.services.create')}}">أضافة خدمة</a>
                            </li>
                  ...
                  <ul class="menu-content">
                    <li><a class="menu-item" href="{{route('admin.aboutus')}}" data-i18n="nav.templates.vert.main">من نحن </a>
                        <ul class="menu-content">
                            <li><a class="menu-item" href="{{route('admin.aboutus')}}"
                                   data-i18n="nav.templates.vert.classic_menu"> كل من نحن</a>
                            </li>
                            <li><a class="menu-item" href="{{route('admin.aboutus.create')}}">أضافة من نحن</a>
                            </li>
                  ...
                  <ul class="menu-content">
                    <li><a class="menu-item" href="{{route('admin.goald')}}" data-i18n="nav.templates.vert.main">أهدافنا </a>
                        <ul class="menu-content">
                            <li><a class="menu-item" href="{{route('admin.goald')}}"
                                   data-i18n="nav.templates.vert.classic_menu"> كل أهدافنا</a>
                            </li>
                            <li><a class="menu-item" href="{{route('admin.goald.create')}}">أضافة أهدافنا</a>
                            </li>
                  ...
                  <ul class="menu-content">
                    <li><a class="menu-item" href="{{route('admin.vision')}}" data-i18n="nav.templates.vert.main">رؤيتنا </a>
                        <ul class="menu-content">
                            <li><a class="menu-item" href="{{route('admin.vision')}}"
                                   data-i18n="nav.templates.vert.classic_menu"> كل رؤيتنا</a>
                            </li>
                            <li><a class="menu-item" href="{{route('admin.vision.create')}}">أضافة رؤيتنا</a>
                            </li>
                  ...
                  <ul class="menu-content">
                    <li><a class="menu-item" href="#" data-i18n="nav.templates.vert.main">شعارنا </a>
                        <ul class="menu-content">
                            <li><a class="menu-item" href="{{route('admin.slogan')}}"
                                   data-i18n="nav.templates.vert.classic_menu"> كل شعارنا</a>
                            </li>
                            <li><a class="menu-item" href="{{route('admin.slogan.create')}}">أضافة شعارنا</a>
                            </li>
                ...
                <ul class="menu-content">
                    <li><a class="menu-item" href="#" data-i18n="nav.templates.vert.main">أفضل المدرسين </a>
                        <ul class="menu-content">
                            <li><a class="menu-item" href="{{route('admin.best-teacher')}}"
                                   data-i18n="nav.templates.vert.classic_menu"> كل أفضل المدرسين</a>
                            </li>
                            <li><a class="menu-item" href="{{route('admin.best-teacher.create')}}">أضافة أفضل المدرسين</a>
                            </li>
                ...
                <ul class="menu-content">
                    <li><a class="menu-item" href="#" data-i18n="nav.templates.vert.main">رؤيتنا </a>
                        <ul class="menu-content">
                            <li><a class="menu-item" href="{{route('admin.services')}}"
                                   data-i18n="nav.templates.vert.classic_menu"> كل رؤيتنا</a>
                            </li>
                            <li><a class="menu-item" href="{{route('admin.services.create')}}">أضافة رؤيتنا</a>
                            </li>
