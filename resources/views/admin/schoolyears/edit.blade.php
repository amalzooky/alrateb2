                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{route('admin.schoolyears')}}">الطلاب </a>
                                </li>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form" action="{{route('admin.schoolyears.update', $schoolYear[0]->id)}}" method="POST">
                                            @csrf
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="text" value="{{$year->name}}" id="name"
                                                                                   class="form-control"
                                                                                   placeholder="  "
                                                                    ...
                                                                    <div class="col-md-6">
                                                                        <div class="form-group">
                                                                            <label for="projectinput1"> السنة الدراسية
                                                                                - {{__('messages.'.$lang -> abbr)}} </label>
                                                                            <input type="text" value="{{$year->years}}" id="name"
                                                                                   class="form-control"
                                                                                   placeholder="  "
