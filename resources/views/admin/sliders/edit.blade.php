                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form"
                                              action="{{route('admin.slider.update',$mainsliders -> id)}}"
                                              method="POST"
                                              enctype="multipart/form-data">
                                            @csrf

                                            <input name="id" value="{{$mainsliders -> id}}" type="hidden">

                                            <div class="form-group">
                                                <div class="text-center">
                                                    <img
                                                        src="{{$mainsliders -> photo}}"
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label for="projectinput1">  العنوان
                                                                - {{__('messages.'.$mainsliders -> translation_lang)}} </label>
                                                            <input type="text" id="name"
                                                                   class="form-control"
                                                                   placeholder="  "
                                                                   value="{{$mainsliders -> name}}"
                                                                   name="slid[0][name]">
                                                            @error("slid.0.name")
                                                    ...
                                                    <div class="col-md-6 hidden">
                                                        <div class="form-group">
                                                            <label for="projectinput1"> أختصار
                                                                اللغة {{__('messages.'.$mainsliders -> translation_lang)}} </label>
                                                            <input type="text" id="abbr"
                                                                   class="form-control"
                                                                   placeholder="  "
                                                                   value="{{$mainsliders -> translation_lang}}"
                                                                   name="slid[0][abbr]">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group mt-1">
                                                            <input type="checkbox" value="1"
                                                                   ...
                                                                   @if($mainsliders -> active == 1)checked @endif/>
                                                            <label for="switcheryColor4"
                                                                   class="card-title ml-1">الحالة {{__('messages.'.$mainsliders -> translation_lang)}} </label>
                                        ...
                                        <ul class="nav nav-tabs">
                                                        @isset($mainsliders -> slideres)
                                                @foreach($mainsliders -> slideres   as $index =>  $translation)
                                        ...
                                        <div class="tab-content px-1 pt-1">
                                            ...
                                            @isset($mainsliders -> slideres)
                                                ...
                                                <form class="form"
                                                      action="{{route('admin.slider.update',$translation -> id)}}"
                                                      method="POST"
                                                      enctype="multipart/form-data">
                                                    @csrf
