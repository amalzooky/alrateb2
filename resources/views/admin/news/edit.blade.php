                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form"
                                              action="{{route('admin.services.update',$mainserves -> id)}}"
                                              method="POST"
                                              enctype="multipart/form-data">
                                            @csrf

                                            <input name="id" value="{{$mainserves -> id}}" type="hidden">

                                            <div class="form-group">
                                                <div class="text-center">
                                                    <img
                                                        src="{{$mainserves -> photo}}"
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label for="projectinput1">  العنوان
                                                                - {{__('messages.'.$mainserves -> translation_lang)}} </label>
                                                            <input type="text" id="name"
                                                                   class="form-control"
                                                                   placeholder="  "
                                                                   value="{{$mainserves -> name}}"
                                                                   name="serve[0][name]">
                                                            @error("serve.0.name")
                                                        ...
                                                        <div class="form-group">
                                                            <label for="projectinput1">  النص
                                                             ...
                                                             <textarea class="tinymce"
                                                                           class="form-control"
                                                                           placeholder="  "
                                                                            value="{{$mainserves ->text}}"
                                                                           name="serve[0][text]">{{$mainserves ->text}} </textarea>
                                                    ...
                                                    <div class="col-md-6 hidden">
                                                        <div class="form-group">
                                                            <label for="projectinput1"> أختصار
                                                                اللغة {{__('messages.'.$mainserves -> translation_lang)}} </label>
                                                            <input type="text" id="abbr"
                                                                   class="form-control"
                                                                   placeholder="  "
                                                                   value="{{$mainserves -> translation_lang}}"
                                                                   name="serve[0][abbr]">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group mt-1">
                                                            <input type="checkbox" value="1"
                                                                   ...
                                                                   @if($mainserves -> active == 1)checked @endif/>
                                                            <label for="switcheryColor4"
                                                                   class="card-title ml-1">الحالة {{__('messages.'.$mainserves -> translation_lang)}} </label>

                                                            @error("serve.0.active")
                                        ...
                                        <ul class="nav nav-tabs">
                                            @isset($mainserves -> services)
                                                @foreach($mainserves -> services   as $index =>  $translation)
                                        ...
                                        <div class="tab-content px-1 pt-1">
                                            ...
                                            @isset($mainserves -> services)
                                                ...
                                                <form class="form"
                                                      action="{{route('admin.services.update',$translation -> id)}}"
                                                      method="POST"
                                                      enctype="multipart/form-data">
                                                    @csrf
