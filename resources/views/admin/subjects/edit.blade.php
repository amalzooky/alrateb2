                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active"> تعديل - {{$subject[0] -> subject_name}}
                                </li>
                            </ol>
                        </div>
                    </div>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form" action="{{route('admin.subjects.update', $subject[0]->id)}}"
                                              method="POST"
                                                            ...
                                                            @if($item->translation_lang === $lang->abbr)
                                                                ...
                                                                <div class="col-lg-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" value="{{$item->subject_name}}" id="name"
                                                                               class="form-control"
                                                                               placeholder="  "
                                                                            ...
                                                                            @if(!empty($majors) && count($majors) > 0)
                                                                                @foreach($majors as $major)
                                                                                    @if($major->translation_lang === $lang -> abbr)
                                                                                        <option value="{{$major->id}}" {{$major->id === $item->subject_major ? 'selected' : ''}}>{{$major->major_name}}</option>
                                                                                    @endif
                                                                                @endforeach
                                                                            @else
                                                                            ...
                                                                            @if(!empty($scYears) && count($scYears) > 0)
                                                                                @foreach($scYears as $year)
                                                                                    @if($year->translation_lang === $lang -> abbr)
                                                                                        <option value="{{$year->id}}" {{$year->id === $item->subject_year ? 'selected' : ''}}>{{$year->name}}</option>
                                                                                    @endif
                                                                                @endforeach
                                                                            @else
                                                                ...
                                                                <div class="col-lg-6">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <select name="subject[{{$index}}][semester]" class="form-control">
                                                                            ...
                                                                            <option value="1" {{$item->subject_semester == 1 ? 'selected' : ''}}>الفصل الدراسى الاول</option>
                                                                            <option value="2" {{$item->subject_semester == 2 ? 'selected' : ''}}>الفصل الدراسى الثانى</option>
                                                                        </select>
                                                                ...
                                                                <div class="col-lg-12">
                                                                    <div class="form-group">
                                                                        <label for="projectinput1">وصف الماده
                                                                            - {{__('messages.'.$lang -> abbr)}} </label>
                                                                        <textarea name="subject[{{$index}}][description]" class="form-control">{{$item->subject_description}}</textarea>
                                                                ...
                                                                <div class="col-lg-3">
                                                                    <div class="form-group">
                                                                        <label for="projectinput1">الاحد
                                                                            - {{__('messages.'.$lang -> abbr)}} </label>
                                                                        <input name="subject[{{$index}}][sunday]" value="{{$item->sunday}}" class="form-control">
                                                                ...
                                                                <div class="col-lg-3">
                                                                    <div class="form-group">
                                                                        <label for="projectinput1">الاثنين
                                                                            - {{__('messages.'.$lang -> abbr)}} </label>
                                                                        <input name="subject[{{$index}}][monday]" value="{{$item->monday}}" class="form-control">
                                                                ...
                                                                <div class="col-lg-3">
                                                                    <div class="form-group">
                                                                        <label for="projectinput1">الثلاثاء
                                                                            - {{__('messages.'.$lang -> abbr)}} </label>
                                                                        <input name="subject[{{$index}}][tuesday]" value="{{$item->tuesday}}" class="form-control">
                                                                ...
                                                                <div class="col-lg-3">
                                                                    <div class="form-group">
                                                                        <label for="projectinput1">الاربعاء
                                                                            - {{__('messages.'.$lang -> abbr)}} </label>
                                                                        <input name="subject[{{$index}}][wednesday]" value="{{$item->wednesday}}" class="form-control">
                                                                ...
                                                                <div class="col-lg-3">
                                                                    <div class="form-group">
                                                                        <label for="projectinput1">الخميس
                                                                            - {{__('messages.'.$lang -> abbr)}} </label>
                                                                        <input name="subject[{{$index}}][thursday]" value="{{$item->thursday}}" class="form-control">
                                                                ...
                                                                <div class="col-lg-3">
                                                                    <div class="form-group">
                                                                        <label for="projectinput1">الجمعه
                                                                            - {{__('messages.'.$lang -> abbr)}} </label>
                                                                        <input name="subject[{{$index}}][friday]" value="{{$item->friday}}" class="form-control">
                                                                ...
                                                                <div class="col-lg-3">
                                                                    <div class="form-group">
                                                                        <label for="projectinput1">السبت
                                                                            - {{__('messages.'.$lang -> abbr)}} </label>
                                                                        <input name="subject[{{$index}}][saturday]" value="{{$item->saturday}}" class="form-control">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group mt-1">
                                                                <input type="checkbox" value="1"
                                                                       ...
                                                                       {{$subject[0]->active == 1 ? 'checked' : ''}}/>
                                                                <label for="switcheryColor4"
                                                                       class="card-title ml-1">الحالة</label>

                                                                @if(!empty(session()->get('errors')['subject.0.active']))
                                                                    <span class="text-danger"> هذا الحقل مطلوب</span>
                                                                @endif
                                                            </div>
                                                        </div>
