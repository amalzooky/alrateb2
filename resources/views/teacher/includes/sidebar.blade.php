<div class="main-menu menu-fixed menu-light menu-accordion    menu-shadow " data-scroll-to-active="true">
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="nav-item "><a href="{{route('teacher.dashboard')}}"><i class="la la-mouse-pointer"></i><span
                        class="menu-title" data-i18n="nav.add_on_drag_drop.main">الرئيسية </span></a>
            </li>

            <li class="nav-item  ">
                <a href="{{route('teacher.lacture')}}"><i class="la la-home"></i>
  ...
  <li class="nav-item  ">
                <a href="{{route('teacher.groups')}}"><i class="la la-home"></i>
            ...
            <li class="nav-item"><a href="{{route('teacher.teachers')}}"><i class="la la-male"></i>
