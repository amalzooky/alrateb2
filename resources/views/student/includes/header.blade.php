                ...
                <li class="nav-item">
                    <a class="navbar-brand" href="index.html">
                        <img class="brand-logo" alt="modern admin logo"
                             src="{{asset('back/images/logo/logo.png')}}">
                        <h3 class="brand-text">الراتب لتفوق والابداع</h3>
                    </a>
                </li>
        ...
        <div class="navbar-container content">
            <div class="collapse navbar-collapse" id="navbar-mobile">
                ...
                <span class="mr-1">مرجبا
                  <span
                      class="user-name text-bold-700">  {{ \Auth::guard('student')->user()->fullname }}</span>
                </span>
                            <span class="avatar avatar-online">
                  <img  style="height: 35px;" src="" alt="avatar"><i></i></span>
                        </a>
                        {{-- \Auth::guard('student')->user()->id ) --}}
                        <div class="dropdown-menu dropdown-menu-right"><a class="dropdown-item" href=" {{ route('student.profile')}}"><i
                                    class="ft-user"></i> الملف الشحصي </a>
                            <div class="dropdown-divider"></div>
                            <a a class="dropdown-item" href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();"><i class="ft-power"></i>
    Logout
</a>
...
{{-- 
                            <a class="dropdown-item" href="{{ url('/logout') }}"><i class="ft-power"></i> تسجيل
                                الخروج </a>
                                <form id="logout-form" action="{{ route('logout') }}" method="POST" style="display: none;">
    {{ csrf_field() }}
</form> --}}
                    ...
                    <li class="dropdown dropdown-notification nav-item">
                        ...
                        <span class="avatar avatar-sm avatar-online rounded-circle">
                                                        {!! !empty($vendor->avatar) ? '<img style="width: 150px; height: 100px;" src="/' . $vendor->avatar . '">' : '' !!}
                               alt="avatar"><i></i></span>
                                        </div>
                                        <div class="media-body">
                        ...
                        <span class="avatar avatar-sm avatar-busy rounded-circle">
                          <img src="{{asset('back/images/portrait/small/avatar-s-2.png')}}" alt="avatar"><i></i></span>
                                        </div>
                                        <div class="media-body">
                                ...
                                <a href="javascript:void(0)">
                                    <div class="media">
                                        <div class="media-left">
                        <span class="avatar avatar-sm avatar-online rounded-circle">
                          <img src="{{asset('back/images/portrait/small/avatar-s-3.png')}}" alt="avatar"><i></i></span>
                                        </div>
                                        <div class="media-body">
                        ...
                        <span class="avatar avatar-sm avatar-away rounded-circle">
                          <img src="{{asset('back/images/portrait/small/avatar-s-6.png')}}" alt="avatar"><i></i></span>
                                        </div>
                                        <div class="media-body">
